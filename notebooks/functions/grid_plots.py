...
def plot_grid_bar(data, columns, by=None, title=None, annotation=None):
    ...
    for i, column in enumerate(columns):
        ...
        sns.histplot(
            data=data, x=column, ax=ax[row, col], hue=by, multiple="dodge", shrink=0.8
        )
...
def plot_grid_displots(
    data,
    columns,
    units_list,
    title="Distributions of Continuous Variables with Median and Mean",
    show_titles=True,
    annotation=None,
):
    """
...
def plot_grid_violin(
    data, binom, continuous_vars, binom_vars, title_fontsize=19, annotation=None
):
    """
